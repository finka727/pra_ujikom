...
$queryJenisService = mysqli_query($koneksi, "SELECT * FROM jenis_service ORDER BY id DESC");
...
if (isset($_GET['delete'])) {
    ...
    $delete = mysqli_query($koneksi, "DELETE FROM jenis_service WHERE id ='$id'");
    header("location:jenis-service.php?hapus=berhasil");
}
?>
<!DOCTYPE html>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div align="right" class="mb-3">
                                            <a href="tambah-jenis-service.php" class="btn btn-primary">Tambah</a>
                                        </div>
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php $no = 1;
                                                while ($rowPaket = mysqli_fetch_assoc($queryJenisService)) { ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        ...
                                                        <td>
                                                            <a href="tambah-jenis-service.php?edit=<?php echo $rowPaket['id'] ?>" class="btn btn-success btn-sm">

...
$queryDataTransaksi = mysqli_query($koneksi, "SELECT customer.customer_name, trans_order.* FROM trans_order LEFT JOIN customer ON customer.id = trans_order.id_customer ORDER BY id DESC");
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowDataTransaksi = mysqli_fetch_assoc($queryDataTransaksi)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $rowDataTransaksi['order_pay'] ?></td>
                                                        <td><?php echo $rowDataTransaksi['order_change'] ?></td>
                                                        <td>

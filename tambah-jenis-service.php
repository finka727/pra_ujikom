...
if (isset($_POST['simpan'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO jenis_service (service_name,price,description) VALUES ('$service_name','$price','$description')");

    header("location:jenis-service.php?tambah=berhasil");
}

$id = isset($_GET['edit']) ? $_GET['edit'] : '';
$queryEdit = mysqli_query($koneksi, "SELECT * FROM jenis_service WHERE id ='$id'");
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE jenis_service SET service_name='$service_name',price='$price',description='$description' WHERE id='$id'");
    header("location:jenis-service.php?ubah=berhasil");
}
